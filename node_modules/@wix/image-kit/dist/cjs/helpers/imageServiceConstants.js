 ...
 */
const MAX_DEVICE_PIXEL_RATIO = exports.MAX_DEVICE_PIXEL_RATIO = 2;

/**
 site BG legacy max width x height
 */
const DSKTP_MAX_BG_SITE_LEGACY_WIDTH = exports.DSKTP_MAX_BG_SITE_LEGACY_WIDTH = 1920;
const DSKTP_MAX_BG_SITE_LEGACY_HEIGHT = exports.DSKTP_MAX_BG_SITE_LEGACY_HEIGHT = 1920;
const MOBILE_MAX_BG_SITE_LEGACY_WIDTH = exports.MOBILE_MAX_BG_SITE_LEGACY_WIDTH = 1000;
const MOBILE_MAX_BG_SITE_LEGACY_HEIGHT = exports.MOBILE_MAX_BG_SITE_LEGACY_HEIGHT = 1000;
 ...
 */
const fittingTypes = exports.fittingTypes = {
  SCALE_TO_FILL: 'fill',
  SCALE_TO_FIT: 'fit',
  STRETCH: 'stretch',
 ...
 */
const transformTypes = exports.transformTypes = {
  FIT: 'fit',
  FILL: 'fill',
 ...
 */
const alignTypes = exports.alignTypes = {
  CENTER: 'center',
  TOP: 'top',
  TOP_LEFT: 'top_left',
  TOP_RIGHT: 'top_right',
 ...
 */
const ALIGN_TYPE_TO_FOCAL_POINT = exports.ALIGN_TYPE_TO_FOCAL_POINT = {
  [alignTypes.CENTER]: {
    x: 0.5,
    y: 0.5
  },
 ...
 */
const alignTypesMap = exports.alignTypesMap = {
  center: 'c',
  top: 't',
  top_left: 'tl',
  top_right: 'tr',
 ...
 */
const upscaleMethods = exports.upscaleMethods = {
  AUTO: 'auto',
  CLASSIC: 'classic',
  SUPER: 'super'
};
 ...
 */
const upscaleMethodsValues = exports.upscaleMethodsValues = {
  classic: 1,
  super: 2
};
 ...
 */
const defaultUSM = exports.defaultUSM = {
  radius: '0.66',
  amount: '1.00',
  threshold: '0.01'
};
 ...
 * default empty data
 */
const emptyData = exports.emptyData = {
  uri: '',
  css: {
    img: {},
    container: {}
...
const SAFE_TRANSFORMED_AREA = exports.SAFE_TRANSFORMED_AREA = MAX_TRANSFORMED_IMAGE_WIDTH * MAX_TRANSFORMED_IMAGE_HEIGHT;

/**
 * super res machine learning upscale factor models -
 * @type {number[]}
 */
const SUPER_UPSCALE_MODELS = exports.SUPER_UPSCALE_MODELS = [1.5, 2, 4];

/**
 * image qualities
 */
const imageScaleDefaults = exports.imageScaleDefaults = {
  HIGH: {
    size: 1400 * 1400,
    quality: 90,
    maxUpscale: 1
 ...
 */
const imageQuality = exports.imageQuality = {
  HIGH: 'HIGH',
  MEDIUM: 'MEDIUM',
  LOW: 'LOW',
  TINY: 'TINY'
 ...
 */
const imageFilters = exports.imageFilters = {
  CONTRAST: 'contrast',
...
const encodingTypes = exports.encodingTypes = {
  AVIF: 'AVIF',
  PAVIF: 'PAVIF'
};
const supportedExtensions = exports.supportedExtensions = [fileType.JPG, fileType.JPEG, fileType.JPE, fileType.PNG, fileType.GIF, fileType.WEBP];
