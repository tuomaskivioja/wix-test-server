...
function getTransform(fittingType, src, target, options) {
  ...
  const canTransformImage = (0, _imageServiceUtils.isImageTransformApplicable)(src.id, options == null ? void 0 : options.hasAnimation, options == null ? void 0 : options.allowAnimatedTransform);
  const transformsObj = {
    fileName,
    fileExtension,
    fileType,
    ...
    src: {
      ...
      height: src.height,
      isCropped: false,
      isAnimated: (0, _imageServiceUtils.imageIsAnimated)(src.id, options == null ? void 0 : options.hasAnimation)
    },
    focalPoint: {
