    ...
    export namespace wix {
        export namespace common {
            ...
            export namespace tags {
                export interface Tags {
                    privateTags?: $requests.wix.common.tags.Tags.TagList;
                    tags?: $requests.wix.common.tags.Tags.TagList;
                }
                export namespace Tags {
                ...
                export interface PublicTags {
                    tags?: $requests.wix.common.tags.PublicTags.TagList;
                }
            ...
            export interface WixLink {
                ...
                tpaPage?: $requests.wix.common.TpaPageLink;
            }
        ...
        export namespace api {
            ...
            export interface Details {
                ...
                systemError?: $requests.wix.api.SystemError;
...
declare namespace $responses {
    export namespace wix {
        export namespace common {
            ...
            export namespace tags {
                export interface Tags {
                    privateTags?: $responses.wix.common.tags.Tags.TagList;
                    tags?: $responses.wix.common.tags.Tags.TagList;
                }
                export namespace Tags {
                    export interface TagList {
                        tagIds?: string[];
                ...
                export interface PublicTags {
                    tags?: $responses.wix.common.tags.PublicTags.TagList;
                }
                export namespace PublicTags {
                    export interface TagList {
                        tagIds?: string[];
            ...
            export interface WixLink {
                ...
                tpaPage?: $responses.wix.common.TpaPageLink;
            }
            export interface ExternalLink {
                url?: string;
                target?: string;
        ...
        export namespace api {
            ...
            export interface Details {
                ...
                systemError?: $responses.wix.api.SystemError;
                tracing?: { [k: string]: string };
            }
            export interface ApplicationError {
                code?: string;
