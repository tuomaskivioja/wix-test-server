...
describe('transformError', () => {
  ...
  describe('validation errors', () => {
    test('strip field name for invalid input from the transformed error', () => {
      ...
      expect((0, _.transformError)(ambassadorHTTPError, transformation, undefined)).toMatchObject({
        constructor: Error,
  ...
  describe('application errors', () => {
    ...
    describe('when applicationError property exists', () => {
      test('returns the application error description and code', () => {
        ...
        const [key1, key2, value1, value2] = (0, _lodash.times)(4, () => (0, _motionRuntimeTestContext.aString)());
        const data = {
          [key1]: value1,
          [key2]: value2
        };
