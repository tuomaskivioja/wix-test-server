...
describe('transformation contract tests', () => {
  ...
  `('$transformationFunction.name - omitting fields', ({
    ...
    const [objectToKeep, objectToOmit] = (0, _lodash.times)(2, () => (0, _motionRuntimeTestContext.anObject)());
  ...
  describe('spread operator', () => {
    ...
    `('$transformationFunction.name - supports complex expressions', ({
      ...
      const [propertyToOmit, valueToOmit, propertyToKeep, valueToKeep] = (0, _lodash.times)(4, () => (0, _motionRuntimeTestContext.aString)());
