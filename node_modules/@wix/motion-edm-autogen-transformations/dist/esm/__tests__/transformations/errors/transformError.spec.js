...
describe('transformError', () => {
    ...
    describe('system errors', () => {
      ...
      `(
            ...
            'transforms the response object message property to a JS error when the details property $description', ({ details }) => {
    ...
    describe('validation errors', () => {
        ...
        details:
          validationError:
            ...
            expect(transformError(ambassadorHTTPError, transformation, undefined)).toMatchObject({
                constructor: Error,
        ...
        test('handles the #wrap custom function', () => {
            ...
            const transformation = set({}, fieldPathPrefix, '#wrap($[0].something, someValueWrapper)');
            const expectedMessage = dedent `
    ...
    describe('application errors', () => {
        ...
        const aRandomApplicationErrorHttpStatusCode = () => aRandomItemFrom([400, 401, 403, 404, 408, 409, 428, 429, 499]);
        const code = aString();
