 ...
 */
export declare function start(options?: StartOptions): Promise<StartResponse & StartResponseNonNullableFields>;
 ...
 */
export declare function verifyDuringAuthentication(code: string, options: VerifyDuringAuthenticationOptions): Promise<StateMachineResponse & StateMachineResponseNonNullableFields>;
 ...
 */
export declare function resendDuringAuthentication(stateToken: string): Promise<StateMachineResponse & StateMachineResponseNonNullableFields>;
