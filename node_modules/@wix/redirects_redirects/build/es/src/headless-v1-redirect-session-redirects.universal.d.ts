 ...
 */
export declare function onRedirectSessionCreated(handler: (event: RedirectSessionCreatedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
export declare function createRedirectSession(options?: CreateRedirectSessionOptions): Promise<CreateRedirectSessionResponse & CreateRedirectSessionResponseNonNullableFields>;
